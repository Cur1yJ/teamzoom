...
describe SportsController do
  ...
  # SportsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested sport as @sport" do
      sport = Sport.create! valid_attributes
      get :show, {:id => sport.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested sport as @sport" do
      sport = Sport.create! valid_attributes
      get :edit, {:id => sport.to_param}, valid_session
      assigns(:sport).should eq(sport)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Sport" do
        expect {
          post :create, {:sport => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sport as @sport" do
        ...
        post :create, {:sport => {}}, valid_session
        assigns(:sport).should be_a_new(Sport)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sport" do
        ...
        put :update, {:id => sport.to_param, :sport => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sport as @sport" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sport.any_instance.stub(:save).and_return(false)
        put :update, {:id => sport.to_param, :sport => {}}, valid_session
        assigns(:sport).should eq(sport)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested sport" do
      sport = Sport.create! valid_attributes
      expect {
        delete :destroy, {:id => sport.to_param}, valid_session
      }.to change(Sport, :count).by(-1)
    end
